...
/*
for just seive use this code
be careful just about MAX (the maximum limit of sieve) , the indes of primes array initialization


#define MAX 1000007
#define LMT sqrt(MAX)

unsigned base[MAX/64],primes[MAX];
